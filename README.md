...
- name: Example how to customize some of the role parameters
  ...
  vars:
    ...
    influxdb_config_graphite_list__default_enabled: yes
  roles:
    - influxdb
...
influxdb_config_meta__default_retention_autocreate: yes
influxdb_config_meta__default_logging_enabled: yes
...
influxdb_config_data__default_trace_logging_enabled: no
influxdb_config_data__default_query_log_enabled: no
...
influxdb_config_retention__default_enabled: yes
...
# Default values of options for the section
influxdb_config_shard__default_enabled: yes
...
# Default values of options for the section
influxdb_config_monitor__default_store_enabled: yes
...
influxdb_config_http__default_enabled: yes
influxdb_config_http__default_bind_address: :8086
influxdb_config_http__default_auth_enabled: no
influxdb_config_http__default_realm: InfluxDB
influxdb_config_http__default_log_enabled: no
influxdb_config_http__default_write_tracing: no
influxdb_config_http__default_pprof_enabled: no
influxdb_config_http__default_https_enabled: no
...
influxdb_config_http__default_unix_socket_enabled: no
...
influxdb_config_subscriber__default_enabled: yes
influxdb_config_subscriber__default_influxdb_config_subscriber__default_enabled: yes
influxdb_config_subscriber__default_http_timeout: 30s
influxdb_config_subscriber__default_insecure_skip_verify: no
...
influxdb_config_graphite_list__default_enabled: no
...
influxdb_config_collectd_list__default_enabled: no
...
influxdb_config_opentsdb_list__default_enabled: no
...
influxdb_config_opentsdb_list__default_tls_enabled: no
influxdb_config_opentsdb_list__default_certificate: /etc/ssl/influxdb.pem
influxdb_config_opentsdb_list__default_log_point_errors: yes
...
influxdb_config_udp_list__default_enabled: no
...
influxdb_config_continuous__default_log_enabled: yes
influxdb_config_continuous__default_enabled: yes
...
influxdb_config_reporting_disabled: no
